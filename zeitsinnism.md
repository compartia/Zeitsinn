...
Наслаждение геометрие jap-дефектов, поиск сходства во внешне разном, поиск разницы в похожем -- это развитие зрелого Цайтзиннизма в стремлении к выходу за плоскость полотна путем внесения символьной иерархии удаленности объектов. 

Поздний цайтзиннизм характеризуется побегом из освоенной трехмерности в голографичность, где добавляется иллюзия времени в приглашающей закончить фразу недосказанности и в указании направления и траектории. Полотна поздних цайтзиннистов равзернуты в пространство всепринемающего времени. 
